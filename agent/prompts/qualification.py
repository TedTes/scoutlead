...
def qualification_prompt(product: ProductRead, lead: LeadRead) -> str:
    ...
    return "\n".join(
        [
            ...
            "When possible, include score_breakdown with separate fit_score, reachability_score, and source_quality_score.",
            "fit_score must reflect ICP/problem fit only; reachability_score must reflect contact quality only.",
